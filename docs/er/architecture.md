...
erDiagram
    ...
    users ||--o{ user_sticker_applications : "aplica"
    unlockables ||--o{ user_sticker_applications : "recibe"
    unlock_factors ||--o{ unlockables : "desbloquea"
    unlock_factors ||--o{ achievements : "desbloquea"
